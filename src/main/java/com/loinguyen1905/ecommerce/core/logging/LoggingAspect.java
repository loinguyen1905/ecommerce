package com.loinguyen1905.ecommerce.core.logging;
...
public class LoggingAspect {
    ...
    private static final Logger LOGGER = LoggerFactory.getLogger(com.loinguyen1905.ecommerce.core.interceptor.RestTemplateFilter.class);
